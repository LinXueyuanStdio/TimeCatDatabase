...
public class UploadUtil {
    ...
    private static byte[] getimage(File srcPath) {
...
//        return bitmap;
    ...
    public static String uploadFile(File file) {
        ...
        try {
            ...
            conn.setRequestProperty("Content-UsageType", CONTENT_TYPE + ";boundary=" + BOUNDARY);
...
//                sb.append(LINE_END);
                ...
                //  sb.append("Content-UsageType: application/octet-stream; charset=" + CHARSET + LINE_END);
                sb.append("Content-UsageType:  image/*" + LINE_END);
                sb.append(LINE_END);
...
//                is.close();
    ...
    public static String post(String url, Map<String, String> params, Map<String, File> files) throws IOException {
        ...
        conn.setRequestProperty("Content-UsageType", MULTIPART_FROM_DATA + ";boundary=" + BOUNDARY);
        // 首先组拼文本类型的参数
        ...
        for (Map.Entry<String, String> entry : params.entrySet()) {
            ...
            sb.append("Content-UsageType: text/plain; charset=" + CHARSET + LINEND);
        ...
        if (files != null) for (Map.Entry<String, File> file : files.entrySet()) {
            ...
            sb1.append("Content-UsageType: application/octet-stream; charset=" + CHARSET + LINEND);
            sb1.append(LINEND);
